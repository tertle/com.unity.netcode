...
#pragma warning restore CS0618
        ...
        {
            if ( hyperLinkData.TryGetValue("href", out var href ) && href == NetCodeHyperLinkArguments.s_OpenPlayModeTools.ToString() )
            {
                ShowWindow();
            }

            if ( hyperLinkData.TryGetValue( "highlight", out var highlight ) && highlight == NetCodeHyperLinkArguments.s_HighlightWarnBatchedTicks.ToString() )
            {
